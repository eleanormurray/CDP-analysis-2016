...
/**This program creates 2 data files for**/
/**analysis of CDP adherence data in******/
/**placebo arm. Creates: *****************/
/*****************************************/
/**Binary.sas7bdat: main dataset with: ***/
/**Old and new adherence definitions******/
/**dichotomized covariates.***************/
/*****************************************/
/*****************************************/
/**censwt_ag.sas7bdat: long-format ********/
/**dataset for analysis of time-varying***/
/**adherence******************************/
/*****************************************/
...
ZLAB88 ZLAB89 ZLAB90 ZLAB91--ZLAB116 
...
IMDCT142-IMDCT157 ICCL1-ICCL15 ZLAB4-ZLAB18 ZLAB91-ZLAB105 
...
keep  age_cat age_bin nonwhite mi_bin rbw_bin;
drop  irc nmi rbw;
...
drop NIHA1-NIHA6 NIHA_FV16-NIHA_FV17;
...
drop KLIN1_FV0-KLIN1_FV15 KLIN2_FV0-KLIN2_FV15 KLIN3_FV0-KLIN3_FV15 KLIN5_FV0-KLIN5_FV15  KLIN7_FV0-KLIN7_FV15
	ICCL1-ICCL15 ICCL27-ICCL41 ICCL53-ICCL67 ICCL157-ICCL171 ICCL235-ICCL249;
...
drop WTBP32 - WTBP47 WTBP61-WTBP76;
...
proc freq data = cdp.binary nlevels;
tables ID /noprint;
...
data cdp.binary;
set cdp.binary;
where adhbin0 ne . and age_bin ne . and  nonwhite ne . and  IRK ne . and  MI_bin ne . and RBW_bin ne . and 
			NIHA_FV0 ne . and  HiSysBP_FV0  ne . and  HiDiasBP_FV0 ne . and   HiWhiteCell_FV0 ne . and   HiNeut_FV0 ne . and   HiHemat_FV0 	 ne . and  
			HiBili_FV0 ne . and   HiSerChol_FV0  ne . and  HiSerTrigly_FV0  ne . and  HiSerUric_FV0  ne . and  HiSerAlk_FV0  ne . and  HiPlasUrea_FV0  ne . and  
			HiFastGluc_FV0  ne . and  HiOneGluc_FV0  ne . and  HiHeart_FV0 ne . and   CHF_FV0 ne . and   ACI_FV0  ne . and  AP_FV0 ne . and  
			IC_FV0  ne . and  ICIA_FV0 ne . and   DIG_FV0  ne . and  DIUR_FV0  ne . and  AntiArr_FV0 ne . and   AntiHyp_FV0 ne . and   OralHyp_FV0  ne . and  
			CardioM_FV0 ne . and   AnyQQS_FV0 ne . and   AnySTDep_FV0  ne . and  AnyTWave_FV0 ne . and  
			STElev_FV0 ne . and   FVEB_FV0 ne . and   VCD_FV0 ne . and   CIG_FV0 ne . and   INACT_FV0 ne .;
run;
