...
%macro partB_adjusted(outdest = , inset = , titlemain = , nboot=, lib=, adhvar = );
...
run;
		...
		proc logistic data = onesample descending;
			model dth5 = &adhvar 
			adhpre0bin age_bin nonwhite IRK MI_bin NIHA_bin1 RBW_bin
...
%partB_adjusted( outdest = "PartA.Adj.logistic.final.rtf", inset = binary, 
